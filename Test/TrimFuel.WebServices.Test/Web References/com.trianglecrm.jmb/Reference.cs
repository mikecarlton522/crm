...
namespace TrimFuel.WebServices.Test.com.trianglecrm.jmb {
    using System;
    ...
    public partial class billing_ws : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public billing_ws() {
            this.Url = global::TrimFuel.WebServices.Test.Properties.Settings.Default.TrimFuel_WebServices_Test_com_trianglecrm_jmb_billing_ws;
        ...
        public void CreateProspectAsync(
                    ...
                    string customField4, 
                    string customField5) {
            this.CreateProspectAsync(username, password, firstName, lastName, address1, address2, city, state, zip, phone, email, ip, affiliate, subAffiliate, internalID, customField1, customField2, customField3, customField4, customField5, null);
        }

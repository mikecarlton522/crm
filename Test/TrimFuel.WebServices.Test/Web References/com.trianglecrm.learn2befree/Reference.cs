...
namespace TrimFuel.WebServices.Test.com.trianglecrm.learn2befree {
    using System;
    ...
    public partial class billing_ws : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public billing_ws() {
            this.Url = global::TrimFuel.WebServices.Test.Properties.Settings.Default.TrimFuel_WebServices_Test_com_trianglecrm_learn2befree_billing_ws;
        ...
        public BusinessErrorOfProspect CreateProspect(string username, string password, string firstName, string lastName, string address1, string address2, string city, string state, string zip, string phone, string email, string ip, string affiliate, string subAffiliate, string internalID) {
        ...
        /// <remarks/>
        public void CreateProspectAsync(string username, string password, string firstName, string lastName, string address1, string address2, string city, string state, string zip, string phone, string email, string ip, string affiliate, string subAffiliate, string internalID) {
            this.CreateProspectAsync(username, password, firstName, lastName, address1, address2, city, state, zip, phone, email, ip, affiliate, subAffiliate, internalID, null);
        }
        ...
        public void CreateProspectAsync(
            ...
            this.InvokeAsync("CreateProspect", new object[] {
                        ...
                        affiliate,
                        subAffiliate,
                        internalID}, this.CreateProspectOperationCompleted, userState);
        }
        ...
        public void ChargeAsync(
                    ...
                    int expYear, 
                    string description) {
            this.ChargeAsync(username, password, amount, shipping, shippingSpecified, productTypeID, productTypeIDSpecified, productID, productIDSpecified, firstName, lastName, address1, address2, city, state, zip, phone, email, ip, affiliate, subAffiliate, internalID, prospectID, prospectIDSpecified, paymentType, creditCard, cvv, expMonth, expYear, description, null);
        }
        ...
        public void ChargeAsync(
            ...
            this.InvokeAsync("Charge", new object[] {
                        ...
                        expMonth,
                        expYear,
                        description}, this.ChargeOperationCompleted, userState);
        }
        ...
        public void CreateSubscriptionAsync(
                    ...
                    int expYear, 
                    string description) {
            this.CreateSubscriptionAsync(username, password, planID, chargeForTrial, firstName, lastName, address1, address2, city, state, zip, phone, email, ip, affiliate, subAffiliate, internalID, prospectID, prospectIDSpecified, paymentType, creditCard, cvv, expMonth, expYear, description, null);
        }

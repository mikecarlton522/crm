<%@ Page Title="" Language="C#" MasterPageFile="~/Controls/Front.Master" AutoEventWireup="true" CodeBehind="cart.aspx.cs" Inherits="Ecigsbrand.Store1.cart" EnableViewState="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphTitle" runat="server">E-Cigs Electronic Cigarette: Online Store Cart</asp:Content>
...
<div id="cart">
  <asp:PlaceHolder runat="server" ID="phSecureBanner" Visible='<%# CurrentState == CartState.Checkout %>'>
    <div style="text-align:center; font-size:20px; font-weight:bold; margin-bottom:20px;">Secure Checkout&nbsp;&nbsp;<img src="images/godaddy.png" width="115" height="60" align="absmiddle">&nbsp;&nbsp;128-Bit Encryption
    </div>
  </asp:PlaceHolder>
  ...
  <uc:ShoppingCart runat="server" ID="ShoppingCart1" OnProductsChanged="ShoppingCart1_ProductsChanged" OnCouponChanged="ShoppingCart1_CouponChanged" OnRefererCodeChanged="ShoppingCart1_RefererCodeChanged" OnGiftCertificateRemoved="BillingInfo1_GiftCertificateRemoved" OnEcigBucksRemoved="ShoppingCart1_EcigBucksRemoved" OnGiftCertificatePopulated="ShoppingCart1_GiftCertificatePopulated" />
  <asp:PlaceHolder runat="server" ID="phBillingError">
  <div id="error">
    <asp:Literal runat="server" ID="lBillingError" />
  </div>
  </asp:PlaceHolder>
  <uc:BillingInfo runat="server" ID="BillingInfo1" Visible='<%# CurrentState == CartState.Checkout %>' OnGiftCertificateAdded="ShoppingCart1_GiftCertificateAdded" OnEcigBucksApplied="BillingInfo1_EcigBucksApplied" />
  <div id="checkout">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="noborder" >
      <tr>
        ...
        <asp:PlaceHolder runat="server" ID="phButtonsCheckout" Visible='<%# CurrentState == CartState.Checkout %>'>
          <td><span class="buttons back"><a href="cart.aspx">&laquo; Change Order</a></span></td>
          <td align="right"><span class="buttons checkout">

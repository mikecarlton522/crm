...
namespace Ecigsbrand.Store1.Logic
{
    ...
    public class ShoppingCart
    {
        ...
        public static Dictionary<KnownProduct, ShoppingCartProduct> KnownProducts = new Dictionary<KnownProduct, ShoppingCartProduct>(){
            ...
            {KnownProduct.NoNicFlavor, new ShoppingCartProduct(){ProductType = ShoppingCartProductType.Upsell, ProductID = 209, Price = 79.99M}},
        ...
        public decimal TotalPoorCost
        {
            get
            {
                ...
                foreach (var item in Products)
                {
                    ...
                    if (Referer != null)
                    {
                        itemAmount = ApplyReferer(itemAmount);
                    }
        ...
        public decimal ApplyReferer(decimal amount)
        {
            decimal res = amount;
            decimal discountValue = 20;

            decimal normalizeDiscount = discountValue / 100M;

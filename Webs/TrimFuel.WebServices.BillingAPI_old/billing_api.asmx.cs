...
using TrimFuel.WebServices.BillingAPI_old.Model;

namespace TrimFuel.WebServices.BillingAPI_old
{
    /// <summary>
    ...
    public class billing_api : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        public BusinessError<ChargeHistory> Charge(decimal amount, string firstName, string lastName,
        ...
        {
            BusinessError<ChargeHistoryEx> resEx = saleService.BillAsUpsell_Old(PRODUCT_ID, amount, null, firstName, lastName,
                address1, address2, city, state, zip, 
                phone, email, ip, null, null, null,
        ...
        [WebMethod]
        public BusinessError<ChargeHistory> Charge2(decimal amount, string firstName, string lastName,
            string address1, string address2, string city, string state, string zip,

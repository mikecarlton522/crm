<%@ Page Title="" Language="C#" MasterPageFile="~/Controls/Front.Master" AutoEventWireup="true" CodeBehind="cp-login.aspx.cs" Inherits="Ecigsbrand.Store2.cp_login" %>
...
<div id="content">
  <div class="left">
    ...
    <p>Sign-in to manage your account, change membership type, view referrals, change address...</p>
    <div class="blueborder" id="login">
      <table width="100%" border="0" cellspacing="0">
        <tr class="noborder">
          <td width="36%">Email (Login):</td>
          <td width="64%">
    ...
    <p>Create a customer account to: view orders, activate referral program, see bonus discounts...</p>

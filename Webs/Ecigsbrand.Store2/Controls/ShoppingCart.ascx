<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ShoppingCart.ascx.cs" Inherits="Ecigsbrand.Store2.Controls.ShoppingCart_" %>
...
<asp:Repeater runat="server" ID="rProducts">
    ...
    <asp:PlaceHolder runat="server" ID="phEcigBucks" Visible='<%# Ecigsbrand.Store2.Logic.ShoppingCart.Current.EcigBucksRedeem > 0M %>'>
        <tr class="total">
          ...
          <td class="last" align="right"><%# FormatPrice(0M - Ecigsbrand.Store2.Logic.ShoppingCart.Current.EcigBucksRedeem) %></td>
        </tr>
    </asp:PlaceHolder>

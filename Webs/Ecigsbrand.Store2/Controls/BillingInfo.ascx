<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BillingInfo.ascx.cs" Inherits="Ecigsbrand.Store2.Controls.BillingInfo" %>
...
<script type="text/javascript">
  ...
  <div id="customer">
    <div id="credit">
      ...
      <asp:PlaceHolder runat="server" ID="phEcigBucks" Visible="<%# Referer != null && Ecigsbrand.Store2.Logic.ShoppingCart.Current.EcigBucksRedeem == 0M && EcigBucksAvailableToApply > 0M%>">
          <div class="space"></div>
          <table width="100%" border="0" cellspacing="0" cellpadding="5">
            <tr class="header">
              <td colspan="2">
      ...
      <asp:PlaceHolder runat="server" ID="phGiftCertificate" Visible="<%# Ecigsbrand.Store2.Logic.ShoppingCart.Current.GiftCertificateList == null || Ecigsbrand.Store2.Logic.ShoppingCart.Current.GiftCertificateList.Count == 0%>">
          <div class="space"></div>

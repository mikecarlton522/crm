<%@ Page Title="" Language="C#" MasterPageFile="~/Controls/Front.Master" AutoEventWireup="true" CodeBehind="cp-account.aspx.cs" Inherits="Ecigsbrand.Store2.account.cp_account" %>
    ...
    <div class="blueborder" id="registration">
      <table width="100%" border="0" cellspacing="0">
        ...
        <tr>
          <td>Country:</td>
          <td>
            <gen:DDLCountry runat="server" ID="ddlCountry" SelectedValue='<%# Referer.Country %>'
              style="width:170px;">
            </gen:DDLCountry>
          </td>
        </tr>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BillingInfo.ascx.cs"
    Inherits="Fitdiet.Store1.Controls.BillingInfo" %>
...
<div id="customer">
    <div id="credit">
        ...
        <asp:PlaceHolder runat="server" ID="phGiftCertificate" Visible="<%# Fitdiet.Store1.Logic.ShoppingCart.Current.GiftCertificateList == null || Fitdiet.Store1.Logic.ShoppingCart.Current.GiftCertificateList.Count == 0%>">
            <div class="space">
            </div>

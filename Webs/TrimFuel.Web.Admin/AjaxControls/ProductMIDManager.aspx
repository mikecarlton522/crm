<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductMIDManager.aspx.cs"
    Inherits="TrimFuel.Web.Admin.AjaxControls.ProductMIDManager" %>
            ...
            <tr>
                ...
                <td>                    
                    <div class="meter-wrap">
                        <div class="meter-value" style='background-color: <%# Math.Round((decimal)( MIDs.SingleOrDefault(m=> m.AssertigyMIDID == Convert.ToInt32(Eval("AssertigyMIDID"))).MonthlyCap == 0 ? 0 : ChargedHistoryEx.Where(ch=>ch.MerchantAccountID == Convert.ToInt32(Eval("AssertigyMIDID"))).Sum(ch => ch.Amount) / MIDs.SingleOrDefault(m=> m.AssertigyMIDID == Convert.ToInt32(Eval("AssertigyMIDID"))).MonthlyCap * 100), 1) <= 50 ?  "green" : (Math.Round((decimal)(ChargedHistoryEx.Where(ch=>ch.MerchantAccountID == Convert.ToInt32(Eval("AssertigyMIDID"))).Sum(ch => ch.Amount) / MIDs.SingleOrDefault(m=> m.AssertigyMIDID == Convert.ToInt32(Eval("AssertigyMIDID"))).MonthlyCap * 100), 1) <= 80 ? "orange" :"red") %>; width: <%# Math.Round((decimal)( MIDs.SingleOrDefault(m=> m.AssertigyMIDID == Convert.ToInt32(Eval("AssertigyMIDID"))).MonthlyCap == 0 ? 0 : ChargedHistoryEx.Where(ch=>ch.MerchantAccountID == Convert.ToInt32(Eval("AssertigyMIDID"))).Sum(ch => ch.Amount) / MIDs.SingleOrDefault(m=> m.AssertigyMIDID == Convert.ToInt32(Eval("AssertigyMIDID"))).MonthlyCap * 100), 1) %>%;'>
                            <div class="meter-text">
                                <asp:Label id="lblMIDStatus" runat="server" Text='<%# Math.Round((decimal)( MIDs.SingleOrDefault(m=> m.AssertigyMIDID == Convert.ToInt32(Eval("AssertigyMIDID"))).MonthlyCap == 0 ? 0 : ChargedHistoryEx.Where(ch=>ch.MerchantAccountID == Convert.ToInt32(Eval("AssertigyMIDID"))).Sum(ch => ch.Amount) / MIDs.SingleOrDefault(m=> m.AssertigyMIDID == Convert.ToInt32(Eval("AssertigyMIDID"))).MonthlyCap * 100), 1) +"%" %>' />
                            </div>
                        </div>
                    </div>
                </td>

...
{
    public partial class CampaignDynamicEmail_ : System.Web.UI.Page
    {
        ...
        {
            get { return Utility.TryGetInt(Request["campaignID"]); }
        }
        ...
        private void InitProps()
        {
            ...
            if (DynamicEmailID != null)
            {
                ...
                if (DynamicEmail.ProductID != null)
                {
                    DynamicEmail.DynamicEmailID = null;
                    DynamicEmail.CampaignID = CampaignID;
                    DynamicEmail.ProductID = null;
                }
        ...
        protected void bSave_Click(object sender, EventArgs e)
        {
            ...
            {
                DynamicEmail = serv.CreateDynamicEmail(null, DynamicEmail.CampaignID, DynamicEmail.DynamicEmailTypeID, DynamicEmail.Days,
            ...
            {
                DynamicEmail = serv.UpdateDynamicEmail(DynamicEmail.DynamicEmailID.Value, null, DynamicEmail.CampaignID, DynamicEmail.DynamicEmailTypeID, DynamicEmail.Days,
                    chbActive.Checked, Utility.TryGetStr(tbFromName.Text), Utility.TryGetStr(tbFromAddress.Text),
                    Utility.TryGetStr(tbSubject.Text), "", "",

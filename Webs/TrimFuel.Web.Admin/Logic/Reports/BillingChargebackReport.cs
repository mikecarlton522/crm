...
namespace TrimFuel.Web.Admin.Logic.Reports
{
    public class BillingChargebackReport
    {
        public BillingChargebackReport(string caseNumber, string companyName, string companyAddress1, string companyAddress2, string assertigyMIDID)
        {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Run run4 = new Run();
            Text text4 = new Text();
            text4.Text = CompanyAddress2;

            run4.Append(text4);

            paragraph17.Append(paragraphProperties17);
            paragraph17.Append(run4);
            ...
            //if (CaseNumber != null)
            //{
            //    body1.Append(CreateHeaderParagraph(string.Format("CASE NUMBER: {0}", CaseNumber)));
            //}
            body1.Append(table1);

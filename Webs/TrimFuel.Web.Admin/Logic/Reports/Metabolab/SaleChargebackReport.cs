...
namespace TrimFuel.Web.Admin.Logic.Reports.Metabolab
{
    public class SaleChargebackReport
    {
        public SaleChargebackReport(string caseNumber, string arnNumber, string companyName, string companyAddress1, string companyAddress2,
            string assertigyMIDID, ChargeHistoryEx ch, Billing b,
            decimal chAmount, string chCurrency)
        {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph pImage1 = CreateParagraph("");
            pImage1.Append(run20);

            Paragraph pImage2 = CreateParagraph("");
            pImage2.Append(run21);

            body1.Append(CreatePageBreak());
            body1.Append(pImage1);
            ...
            body1.Append(CreateHeaderParagraph("Transaction Information", true));

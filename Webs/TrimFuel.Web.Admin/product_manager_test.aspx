<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="product_manager_test.aspx.cs"
    Inherits="TrimFuel.Web.Admin.product_manager_test" MasterPageFile="~/Controls/Admin.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphScript" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showSetting(type, productId, productName, typeName) {
            ...
            if (type == "mid") {
                url = "ajaxControls/ProductMIDManager_test.aspx?productId=" + productId;
            }
            ...
            if (type == "flow") {
                url = "ajaxControls/ProductFlowManager_test.aspx?productId=" + productId;
            }
            if (type == "events") {

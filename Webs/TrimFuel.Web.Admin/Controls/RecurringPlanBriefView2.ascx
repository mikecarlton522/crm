<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RecurringPlanBriefView2.ascx.cs" Inherits="TrimFuel.Web.Admin.Controls.RecurringPlanBriefView2" %>
<%@ Register Assembly="TrimFuel.Web.UI" Namespace="TrimFuel.Web.UI" TagPrefix="cc1" %>
<table class="editForm subscription"" border="0" cellpadding="0" cellspacing="2"><tr valign="top">    

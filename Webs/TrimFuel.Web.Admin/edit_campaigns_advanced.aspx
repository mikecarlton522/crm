<%@ Page Title="" Language="C#" MasterPageFile="~/Controls/Admin.Master" AutoEventWireup="true"
    CodeBehind="edit_campaigns_advanced.aspx.cs" Inherits="TrimFuel.Web.Admin.edit_campaigns_advanced"
    ValidateRequest="false" AspCompat="true" %>

<%@ Register Src="Controls/SubscriptionControl/CampaignSubscription.ascx" TagName="CampaignSubscription"
    TagPrefix="uc1" %>
<%@ Register Src="Controls/SubscriptionControl/CampaignSubscriptionWithoutTrial.ascx"
    TagName="CampaignSubscriptionWithoutTrial" TagPrefix="uc1" %>
<%@ Register Src="Controls/SubscriptionControl/CampaignSubscriptionWithoutTrial.ascx"
    TagName="CampaignSubscriptionWithoutTrial" TagPrefix="uc2" %>
<%@ Register Src="Controls/SubscriptionControl/CampaignSubscriptionWithoutTrial.ascx"
    TagName="CampaignSubscriptionWithoutTrial" TagPrefix="uc3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphScript" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#tabs").tabs();
            //            $("#bs-tabs").tabs({
            //               selected: <%= hdnSubscriptionTab.Value %>,
            //               select: function(event, ui) {
            //                  $("#<%= hdnSubscriptionTab.ClientID %>").val(ui.index);
            //               }
            //            });
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <table cellpadding="3">
        ...
        <tr>
            ...
            <td colspan="2">
                <!--
                <asp:HiddenField runat="server" ID="hdnSubscriptionTab" />
                <div id="bs-tabs" class="data">
                    <ul>
                        <li><a href="#bs-tab-1">Subscription</a></li>
                        <li><a href="#bs-tab-2">New schema subscription</a></li>
                    </ul>
                    <div id="bs-tab-1">
                ...
                -->
                <uc1:CampaignSubscription ID="subscription1" runat="server" />
            </td>
        </tr>
        <tr>
            <td style="width: 270px;">
                    ...
                    <div id="tabs-4">
                        <table>
                            ...
                            <tr class="upsell1-subscription" style="display: none;">
                                <td colspan="2">
                                    <uc1:CampaignSubscriptionWithoutTrial ID="CampaignSubscriptionUpsell1" runat="server" />
                                </td>
                            </tr>
                            <tr class="upsell1-no-subscription">
                                <td>
                    ...
                    <div id="tabs-5">
                        <table>
                            ...
                            <tr class="upsell2-subscription" style="display: none;">
                                <td colspan="2">
                                    <uc2:CampaignSubscriptionWithoutTrial ID="CampaignSubscriptionUpsell2" runat="server" />
                                </td>
                            </tr>
                            <tr class="upsell2-no-subscription">
                                <td>
                    ...
                    <div id="tabs-6">
                        <table>
                            ...
                            <tr class="upsell3-subscription" style="display: none;">
                                <td colspan="2">
                                    <uc3:CampaignSubscriptionWithoutTrial ID="CampaignSubscriptionUpsell3" runat="server" />
                                </td>
                            </tr>
                            <tr class="upsell3-no-subscription">
                                <td>
